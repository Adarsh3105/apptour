import 'package:apptour/showcase_widget.dart';
  ...
  const Showcase({
    ...
    //this.positionTop,
        ...
        assert(key != null ||
            ...
            textColor != null ||
            shapeBorder != null ||
            animationDuration != null||centerText!=null);
              ...
              child: GestureDetector(
                ...
                child: Center(
                  child: Container(
                    ...
                    child: Center(
                      child: Text(widget.centerText==null?'':
                        widget.centerText,
                        style: TextStyle(decoration: TextDecoration.none, fontSize: 30, color: Colors.blue),
                      ),
                    ),
                  ),
                ),
